...
// Table Functions
export function createTableHeader(table: HTMLTableElement): void {
...
export function addRowToTable(table: HTMLTableElement, player: Player, index: number) {
...
export function refreshTable(tableId: string, players: Player[]) {
